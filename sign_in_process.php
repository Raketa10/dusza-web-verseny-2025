<?php
    ...
    try{
        if ($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $statement = $connection->prepare("SELECT user_id FROM damareen_users WHERE username = ?");
            if ($statement === false) {
            ...
            $statement = $connection->prepare("INSERT INTO damareen_users (username, password_hash) VALUES (?, ?)");
