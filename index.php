...
<body data-logged-in="<?php if (isset($_SESSION["user_id"])){echo "true";}else{echo "false";}?>">
    <div class="screen-container" data-screen="home">
        ...
        <div class="screen screen--game-deck">
            ...
            <div class="game-cards game-casemate-cards">
                <h3>Kazamata kártyái</h3>
            ...
            <div class="game-cards game-player-cards">
                ...
                <div class="game-player-cards-wrapper">
                    <div class="game-player-cards-placeholder"></div>
                    <div class="game-player-cards-container"></div>
                </div>
            </div>
            <div class="game-casemates">
                <h3>Kazamaták</h3>
    ...
    <dialog class="dialog dialog-popup warning" id="popup-world-discard" closedby="none">
        <h1>Biztosan kilépsz mentés nélkül?</h1>
        <p>
            Ha a "Kilépés" gombra kattintasz, azzal elveted a módosításokat, és a világ nem lesz mentve. Kattints a "Mentés" gombra, hogy elmentsd a világot.
        </p>
